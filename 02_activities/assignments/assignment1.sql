...
SELECT 
    v.vendor_id,
    v.vendor_name,
    COUNT(vba.vendor_id) AS booth_rental_count -- using aggregate function COUNT() here --
FROM 
    vendor AS v
INNER JOIN 
    vendor_booth_assignments AS vba
...
-- Step 1: Create a temporary table by copying the original vendor table
